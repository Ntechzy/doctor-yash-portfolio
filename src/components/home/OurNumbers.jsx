...
const OurNumber = () => {
    ...
    return (
        <div className="bg-[#016263] relative -bottom-[100px] before:absolute before:w-full rounded-lg before:h-full overflow-hidden before:top-0 before:bg-[#016263] before:z-[20] bg-[url('/assets/bg-1.jpg')] text-white md:py-8 md:max-w-[1140px] sm:max-w-[720px] w-full flex flex-col  m-auto gap-7 ">
