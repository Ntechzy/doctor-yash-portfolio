        ...
        <div className="flex flex-col items-center m-auto px-4 sm:px-8 lg:px-16 mb-[150px] mt-[50px] ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {SpecializationData.map((data, i) => (
                    <div
                        key={i}
                        className="flex flex-col overflow-hidden border-[1px] border-gray-300 p-4 sm:p-6 lg:p-8 gap-5 rounded-lg shadow-lg relative hover:shadow-xl hover:before:w-full before:absolute before:h-1 before:transition-all before:duration-300 
